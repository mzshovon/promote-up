        ...
        <div class="m-grid__item m-grid__item--fluid m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo" style="margin-bottom: 40px">
                    <a href="#">
                        <img width="100" src="{{asset('/')}}assets/promote/assets/images/promote-removebg-preview.png">
                    </a>
                </div>

                <div class="m-login__signin">
                    <div class="m-login__head mb-4">
                        <h3 class="m-login__title">Sign in to Promote-Up Admin</h3>
                    </div>
...
<!--begin::Page Snippets -->
{{--<script src="{{asset('/')}}assets/snippets/custom/pages/frontend/login.js" type="text/javascript"></script>--}}
<!--end::Page Snippets -->

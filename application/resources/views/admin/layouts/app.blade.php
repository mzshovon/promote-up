...
<!--end::Base Styles -->
    ...
    <link rel="shortcut icon" href="{{asset('/')}}assets/promote/assets/images/promote-removebg-preview.png"/>
...
<script src="{{asset('/')}}assets/promote/excel/jquery.tableToExcel.js" type="text/javascript"></script>
{{--<script src="https://cdnjs.com/libraries/Chart.js" type="text/javascript"></script>--}}
<!--end::Base Scripts -->

    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Add Boosting</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Add Boosting</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/boosting/store/')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('title') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="page_name" value="{{old('title')}}" class="form-control m-input" placeholder="" required>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('title') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="number" name="dollar_cost" value="{{old('title')}}" class="form-control m-input" placeholder="" required>
                                            {!! $errors->first('title', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('title') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="number" name="taka_cost" value="{{old('title')}}" class="form-control m-input" placeholder="" required>
                                            {!! $errors->first('title', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('title') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="number" name="payment" value="{{old('title')}}" class="form-control m-input" placeholder="" required>
                                            {!! $errors->first('title', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('title') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="payment_owner" value="{{old('title')}}" class="form-control m-input" placeholder="" required>
                                            {!! $errors->first('title', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>

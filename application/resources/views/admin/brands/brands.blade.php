        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                        ...
                        <div class="mr-auto">
                            <form class="form-inline" method="get" action="{{url()->current()}}">
                                <div class="form-group mx-sm-2 mb-2">
                                    ...
                                    <input type="search" class="form-control form-control-sm" name="brand_search" value="{{app('request')->brand_search}}" id="inputSearch" placeholder="Search...">
                                </div>
                    ...
                    <div id="refresh">
                        @include('admin.brands.render-brands')
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    console.log(id);
                    $.ajax({
                        url: "{{URL::to('admin/brands/delete/')}}",
                        method: "POST",
        ...
        function statusFunction(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/brands/change-status')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {

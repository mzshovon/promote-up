    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/brands/edit')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <div class="m-form__heading mb-0">
                                                <h3 class="m-form__heading-title mb-0">Brand Details</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row" {{ $errors->has('name') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="name" value="{{old('name',@$brand->name)}}" class="form-control m-input" placeholder="">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <textarea name="description" id="description" class="form-control" rows="3">{{old('bio',@$brand->description) }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <select name="department_id" id="department_id" class="plxSelect2 form-control" required>
                                                @forelse($departments_list as $department)
                                                    <option value="{{@$department->id}}" {{(old ('department_id', @$brand->department_id) == @$department->id) ? 'selected' : ''}}>{{@$department->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                    ...
                                    <div class="form-group m-form__group row" {{@$errors->has('status') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <select name="status" id="status" class="plxSelect2 form-control" required>
                                                ...
                                                <option value="2" {{(old ('status', @$brand->status) == 2) ? 'selected' : ''}}>InActive</option>
                                            </select>

    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Edit Department</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/departments/edit')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <div class="m-form__heading mb-0">
                                                <h3 class="m-form__heading-title mb-0">Department Details</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row" {{ $errors->has('name') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="name" value="{{old('name',$department->name)}}" class="form-control m-input" placeholder="">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <textarea name="description" id="description" class="form-control" rows="3">{{old('bio',$department->description) }}</textarea>
                                        </div>
                                    </div>

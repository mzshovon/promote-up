    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Departments</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Departments</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                        ...
                        <div class="mr-auto">
                            <form class="form-inline" method="get" action="{{url()->current()}}">
                                ...
                                <div class="form-group mx-sm-2 mb-2">
                                    ...
                                    <input type="search" class="form-control form-control-sm" name="department_search" value="{{app('request')->department_search}}" id="inputSearch" placeholder="Search...">
                                </div>
                    ...
                    <div id="refresh">
                        @include('admin.departments.render-departments')
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    console.log(id);
                    $.ajax({
                        url: "{{URL::to('admin/departments/delete/')}}",
                        method: "POST",
        ...
        function statusFunction(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/departments/change-status')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {
                    ...
                    Swal.fire(
                        'Changed!',
                        'Departments Status has been changed.',
                        'success'
                    )
                }
            })

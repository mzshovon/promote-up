                        ...
                        <div class="m-portlet__body m--full-height">
                            ...
                            <div class="m-scrollable" data-scrollable="true" data-height="400" data-scrollbar-shown="true">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td width="25%"><a href="{{url('users/details-12')}}">Melina Chirnoagă</a></td>
                                        <td width="25%" class="text-center">2532</td>
                                        <td width="25%" class="text-center">1536</td>
                                        <td width="25%" class="text-right">65</td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><a href="{{url('users/details-12')}}">Volkan Güneş</a></td>
                                        <td width="25%" class="text-center">2532</td>
                                        <td width="25%" class="text-center">1536</td>
                                        <td width="25%" class="text-right">65</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width="25%"><a href="{{url('users/details-12')}}">Ruxandra Mureșan</a></td>
                                        <td width="25%" class="text-center">2532</td>
                                        <td width="25%" class="text-center">1536</td>
                                        <td width="25%" class="text-right">65</td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><a href="{{url('users/details-12')}}">Alfonz Krajčír</a></td>
                                        <td width="25%" class="text-center">2532</td>
                                        <td width="25%" class="text-center">1536</td>
                                        <td width="25%" class="text-right">65</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width="25%"><a href="{{url('users/details-12')}}">Róka Vencel</a></td>
                                        <td width="25%" class="text-center">2532</td>
                                        <td width="25%" class="text-center">1536</td>
                                        <td width="25%" class="text-right">65</td>
                                    </tr>

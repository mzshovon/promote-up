        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                    ...
                    <div id="refresh">
                        @include('admin.orders.render-orders')
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function deleteFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    console.log(id);
                    $.ajax({
                        url: "{{URL::to('admin/orders/delete/')}}",
                        method: "POST",
        ...
        function pendingFunction(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/orders/pending-status')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {
        ...
        function completeFunction(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/orders/complete-status')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {
        ...
        function cancelFunction(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/orders/cancel-status')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {

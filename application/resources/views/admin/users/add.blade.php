    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/users/store')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('city') ? 'has-error' : ''}}>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('zip_code') ? 'has-error' : ''}}>
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Post Code: </label>
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="zip_code" class="form-control m-input" placeholder="">
                            ...
                            <div class="m-form__actions m-form__actions">
                                <div class="row">
                                    <div class="col-lg-9 ml-lg-auto">
                                        <button type="submit" class="btn btn-brand"><i class="la la-save"></i> &nbsp; ADD</button>
                                    </div>
                                </div>
                            </div>
                        </div>

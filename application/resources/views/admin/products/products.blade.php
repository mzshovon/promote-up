    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Products</h3>
        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                    ...
                    <div id="refresh">
                        @include('admin.products.render-products')
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function deleteFunction(id) {
            Swal.fire({
                ...
                if (result.value) {
                    console.log(id);
                    $.ajax({
                        url: "{{URL::to('admin/products/delete/')}}",
                        method: "POST",
        ...
        function statusFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/products/change-status')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {
                    ...
                    Swal.fire(
                        'Changed!',
                        'Products Status has been changed.',
                        'success'
                    )
                }
            })

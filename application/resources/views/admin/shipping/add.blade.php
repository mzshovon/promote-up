    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Add Shipping Cost </h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Add Shipping Cost</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/shipping/add/')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row">
                                        <label for="weight_range" class="col-xl-3 col-lg-3 col-form-label text-right">Weight Amount:</label>
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="number" name="weight_range" value="{{old('weight_range')}}" class="form-control m-input" placeholder="" >
                                            {!! $errors->first('weight_range', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row">
                                        <label for="cost" class="col-xl-3 col-lg-3 col-form-label text-right">Weight Charge:</label>
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="cost" value="{{old('cost')}}" class="form-control m-input" placeholder="" required>
